...
class _DoctorEditProfileState extends State<DoctorEditProfile>
  ...
  void initState() {
    super.initState();
    widget.nameController.text = doctorProfileModel!.name;
    widget.emailController.text = doctorProfileModel!.email;
    widget.phoneNumberController.text = doctorProfileModel!.phoneNumber ?? '';
    widget.qualificationController.text = doctorProfileModel!.qualification;
    widget.departmentsController.text = doctorProfileModel!.department;
    widget.experienceController.text = doctorProfileModel!.experience;
    widget.expertiseController.text = doctorProfileModel!.areaOfExpertise;
    widget.startingTimeController.text = doctorProfileModel!.opTimeStart;
    widget.finishingTimeController.text = doctorProfileModel!.opTimeEnd;
    widget.feeAmountController.text = doctorProfileModel!.fee.toString();
    widget.daysController.text = doctorProfileModel!.days.toString();
    widget.imageController.text = doctorProfileModel!.imagePath;
    if (doctorProfileModel!.days.contains(1)) {
      isSundaySelected = true;
    }
    if (doctorProfileModel!.days.contains(2)) {
      isMondaySelected = true;
    }
    if (doctorProfileModel!.days.contains(3)) {
      isTuesdaySelected = true;
    }
    if (doctorProfileModel!.days.contains(4)) {
      isWednesdaySelected = true;
    }
    if (doctorProfileModel!.days.contains(5)) {
      isThursdaySelected = true;
    }
    if (doctorProfileModel!.days.contains(6)) {
      isFridaySelected = true;
    }
    if (doctorProfileModel!.days.contains(7)) {
                          ...
                          child: Stack(
                            children: [
                              CustomCircularImageCard(
                                ...
                                imagePath: doctorProfileModel!.imagePath,
                                radius: 160,
                              ),
                              const Align(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CustomTextFormField(
                            ...
                            textController: widget.qualificationController,
                            validator: (val) {
                              return isValid(
                        ...
                        child: SizedBox(
                          ...
                          child: MouseRegion(
                            ...
                            child: CustomSmallTextFormField(
                                ...
                                textController: widget.departmentsController),
                          ),
                        ),
                      ),
                    ],
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: CustomTextFormField(
                        iconData: Icons.timer,
                        textController: widget.finishingTimeController,
                        validator: (val) {
                          return isValid(
                    ...
                    if (_formKey.currentState!.validate()) {
                      doctorProfileEditController.editProfile(
                          DoctorEditProfileModel(
                              ...
                              qualification:
                                  widget.qualificationController.text,
                              department: widget.departmentsController.text,
                              experience: widget.experienceController.text,
                              expertise: widget.expertiseController.text,
                              startingTime: widget.startingTimeController.text,
                              finishingTime:
                                  widget.finishingTimeController.text,
                              days: selectedDays(),
                              feeAmount:
                                  int.parse(widget.feeAmountController.text),
                              isRequested: true,
                              imagePath: widget.imageController.text
                              // image: widget.
                              ),
                          context);
                    }
